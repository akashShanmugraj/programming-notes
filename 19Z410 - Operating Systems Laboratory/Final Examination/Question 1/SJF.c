/*
 NOTE:
 1. Ignored sorting the processes by burst time (probably not expected)
 (selection sort implemented in Lab Manual)
 2. Processes have been inserted into the doubly linked list manually in the
 sorted based on burst time
*/
...
int ShortestJobFirst(struct process *processhead) {
