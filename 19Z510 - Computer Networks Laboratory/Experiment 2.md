...
11. **Getmac**: Displays the MAC (Media Access Control) address for network adapters.
...
8. **IP**: Displays or manipulates routing, devices, policy routing, and tunnels on the network interface.
